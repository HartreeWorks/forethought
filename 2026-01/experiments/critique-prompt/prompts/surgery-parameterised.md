...
2. **Load-bearing claims** (identify the key ones): Which premises, if false, would collapse the conclusion?
...
Generate **{{num_critiques}} critiques total** across the load-bearing claims, using different attack types:
