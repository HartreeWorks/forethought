...
Every paper has **key inferences**—the steps that do most of the work. Find 5 of them.

State each as: "The paper argues that **A** implies **B**, because **mechanism M**."

### Step 2: Generate 15 objections (3 per central move)
...
15. [Fifteenth critique - complete paragraph with name]
