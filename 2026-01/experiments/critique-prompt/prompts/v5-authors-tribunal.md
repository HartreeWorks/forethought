...
Produce 2× the needed number of candidate objections targeting the paper's central claims. For each candidate:
...
From your candidates, select the strongest survivors. For each, provide the refined critique—incorporating anything you learned from the stress test to make it sharper.
