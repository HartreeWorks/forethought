#!/usr/bin/env python3
"""
Critique Prompt Experiment: Gemini 3 Pro

Tests which of 4 critique prompts produces the highest quality individual
critiques using Gemini 3 Pro, measured by ACORN grader scores (GPT-5.2 Pro).
...
PAPER_CONFIGS = {
    "no-easy-eutopia": {
        ...
        "outputs_dir": BASE_DIR / "outputs-gemini",
    ...
    "compute-bottlenecks": {
        ...
        "outputs_dir": BASE_DIR / "outputs-gemini-cb",
        "results_dir": BASE_DIR / "results-gemini-cb",
    },
    "convergence-and-compromise": {
        ...
        "outputs_dir": BASE_DIR / "outputs-gemini-cc",
        "results_dir": BASE_DIR / "results-gemini-cc",
    },
}
...
def generate_critiques(model: genai.GenerativeModel, prompt_template: str, paper_text: str) -> str:
    """Generate critiques using Gemini 3 Pro."""
    ...
    print(f"  Generating critiques with Gemini 3 Pro...")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run critique prompt experiment with Gemini")
    ...
    for prompt_name, prompt_path in prompts_to_run.items():
        ...
        for paper_name, paper_path in PAPERS.items():
            ...
            if output_file.exists():
                ...
                output = generate_critiques(gemini_model, prompt_template, paper_text)
