#!/usr/bin/env python3
"""
Critique Prompt Experiment: GPT-5.2 Pro

Tests which of 3 critique prompts produces the highest quality individual
critiques using GPT-5.2 Pro, measured by ACORN grader scores.
...
PROMPTS = {
    # Baseline prompts (human-written)
    "baseline-v1": PROMPTS_DIR / "baseline-v1-parameterised.md",  # Original (2-4 sentences)
    "baseline-v2": PROMPTS_DIR / "baseline-v2-parameterised.md",  # Matched length (4-7 sentences, titled)
    "conversational": PROMPTS_DIR / "conversational-parameterised.md",  # Minimal conversational prompt
    # Base prompts (AI-generated)
    ...
    # Gemini-originated prompts
    "gemini-surgery": PROMPTS_DIR / "gemini-surgery-parameterised.md",
    "gemini-personas": PROMPTS_DIR / "gemini-personas-parameterised.md",
    "gemini-unforgettable": PROMPTS_DIR / "gemini-unforgettable-parameterised.md",
    # GPT-originated prompts
    "gpt-surgery": PROMPTS_DIR / "gpt-surgery-parameterised.md",
    "gpt-personas": PROMPTS_DIR / "gpt-personas-parameterised.md",
    "gpt-unforgettable": PROMPTS_DIR / "gpt-unforgettable-parameterised.md",
}

# ACORN Grader
GRADER_PATH = Path("/Users/ph/Documents/Projects/2025-09-forethought-ai-uplift/work/2026-01/experiments/tools/acorn-benchmark-promptfoo-port/prompts/grader-v2-acorn-rubric.txt")
...
def generate_critiques(client: openai.OpenAI, prompt_template: str, paper_text: str) -> str:
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run critique prompt experiment")
