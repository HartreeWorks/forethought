...
url: https://www.forethought.org/research/convergence-and-compromise
---
...
The considerations canvassed in this essay have led to significant updates in our views. For example, in What We Owe The Future, Will said he thought that the expected value of the future, given survival, was less than 1% of what it might be.[1](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-1) After being exposed to some of the arguments in this essay, he revised his views closer to 10%; after analysing them in more depth, that percentage dropped a little bit, to 5%-10%. We think that these considerations provide good arguments against extreme views where _Flourishing_ is close to 0, but we still think that _Flourishing_ has [notably greater scale](https://www.forethought.org/research/supplement-the-basic-case-for-better-futures#scale) than _Surviving_.

## 2\. Will most people aim at the good?

In this section, we’ll first consider whether, under reasonably good conditions,[2](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-2) _most_ people with power would converge on an accurate understanding of what makes the future good, and would be significantly motivated to pursue the good.[3](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-3) We’ll call this widespread, accurate, and motivational convergence, or “WAM-convergence”. Second, we’ll consider how likely it is that we will in fact reach those “reasonably good” conditions. (We’ll here assume that, given WAM-convergence, we will reach a mostly-great future.)
...
In the world today, people with very different worldviews nonetheless widely agree on the value of bringing about goods like health, wealth, autonomy, and so on. What’s more, much of the apparent moral disagreement we see is a result of _empirical_ disagreement, rather than fundamental moral disagreement[6](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-6) — for example, two people might disagree over whether euthanasia should be legalised, but only because they disagree about the likely societal consequences. Because of this, it might seem like, really, humans all broadly share the same values, such that we are already close to WAM-convergence.
...
![A diagram depicts reflection as a series of random walks from a shared origin. In the “present day” case, no view has had time to diverge much from the origin. In the “future” case, many different views widely diverge.](https://images.ctfassets.net/4owxfjx3z3if/3Th7hTYdp4ApLzBpX4x7Nx/0b65bcd0a085c9d104c6a3571d4f91b1/moral_views_random_walk_divergence.png?w=3840&q=75&fm=webp)
...
But there must be a vast range of different kinds of experience which computation could support, including kinds never before experienced, hard to even discover, or impossible to experience while maintaining essential facts about your personal identity. And, given antirealism, there are no shared, obvious, and objective qualities of experiences themselves that indicate how valuable they are.[25](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-25) So there’s no reason to expect significant convergence among antirealists about which experiences involve the most “efficient” production of “hedonic value”.[26](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-26) Antirealists can appeal to “shared human preferences” as a reason for moral convergence. But such preferences are extremely underpowered for this task — like two people picking the same needle out of an astronomical haystack.[27](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-27),[28](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-28)
...
Second, people in the future could have the wrong _non-moral_ views, especially if those views have greater memetic power (in some circumstances) than the correct views.[32](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-32) Some ideas might even be so memetically potent that merely considering the idea makes an individual highly likely to adopt it; such ideas might also discourage further change, and become impossible to get out of, like epistemic black holes.
...
First, the best actions are higher-impact in scenario (3) than in scenario (1). Suppose that you’re in scenario (1), that you currently have 1 billionth of all global power,[56](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-56) and that the future is on track to achieve one hundred millionth as much value as if you had all the power.[57](https://www.forethought.org/research/convergence-and-compromise#user-content-fn-57) Perhaps via successful power-seeking throughout the course of your life, you could increase your current level of power a hundredfold. If so, then you would ensure that the future has one millionth as much value as if you had all the power. You’ve increased the value of the future by one part in a million.
...
[No Easy Eutopia](https://www.forethought.org/research/no-easy-eutopia) [Persistent Path-Dependence](https://www.forethought.org/research/persistent-path-dependence)

1

MacAskill, ‘What We Owe the Future: A Million-Year View’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-1)

2

By “reasonably good conditions”, we mean that none of the “blockers” [discussed in 2.5](https://www.forethought.org/research/convergence-and-compromise#25-blockers) occur. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-2)

3

This need not be their _initial_ motivation. On strong forms of moral realism, it could be that as people reflect, they come to form the desire to promote the good de dicto, even if they did not have that motivation originally. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-3)

4

The idea of being motivated by promoting the good de dicto has a bad rap in academic philosophy, on the grounds that it’s implausibly “fetishistic” (for a seminal discussion, see Williams, [‘Persons, character and morality’](https://www.cambridge.org/core/books/moral-luck/persons-character-and-morality/B3096FF4B0780A9A58D019EE3A968678).) But, as we’ll discuss, reaching a mostly-great future could essentially require some people to be motivated by the good de dicto. The rough idea is that if a mostly-great future presents a narrow target, then it would be a coincidence if that target were hit, unless enough people were explicitly trying to hit it. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-4)

5

Similarly, if Bob says “I want to speak with the manager” because the manager is a friend of his, and he wouldn't want to speak to the manager if it wasn’t that friend, he is speaking of “the manager” de re. If Bob says “I want to speak with the manager” because he has a complaint to make to whoever the manager is, he is speaking of “the manager” de dicto. He might also then be motivated to proactively learn who the manager is, if he’s unsure. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-5)

6

For extended discussion, see: Boyd, [‘How to Be a Moral Realist’](https://philpapers.org/rec/BOYHTB), Railton, [‘Facts, Values, and Norms: Essays toward a Morality of Consequence’](https://www.cambridge.org/core/books/facts-values-and-norms/5B8C2C2969882F8ECCAF5AEE765D3868), and Brink, [‘Moral Realism and the Foundations of Ethics’](https://www.cambridge.org/core/books/moral-realism-and-the-foundations-of-ethics/E7F518009F785359B41449E99E1FBD6A). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-6)

7

For some relevant discussion at the level of individual psychology, see Hanson and Simler, ‘ [The Elephant in the Brain: Hidden Motives in Everyday Life](https://www.elephantinthebrain.com/)’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-7)

8

See Fukuyama, ‘ [The End of History and the Last Man](https://www.penguin.co.uk/books/13399/the-end-of-history-and-the-last-man-by-fukuyama-francis/9780241991039)’, especially Section IV. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-8)

9

In particular, we could model the process of reflection as a series of independent Brownian motions in R2\\mathbb{R}^{2}R2, all starting at the same point at the same time. Then the expected distance of a view from the starting point, and the expected distance between two given views, both increase with the square root of time. The latter expectation is larger by a factor of 2\\sqrt{2}2​. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-9)

10

World Values Survey, ‘ [Inglehart–Welzel Cultural Map](https://www.worldvaluessurvey.org/WVSContents.jsp?CMSID=Findings)’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-10)

11

We’ll note that it’s not completely clear that, overall, values are converging. Jackson and Medvedev, ‘Worldwide divergence of values’ finds that over the last 40 years there’s been a growing gap between Western countries and the rest of the world, in particular around "emancipative values," which include the justifiability of homosexuality, euthanasia, divorce, suicide, child obedience, prostitution, and abortion. Oceanic, European, North American, and South American countries have increasingly adopted emancipative values. But in Africa and Asia, the endorsement of these values has been stable or even declining over the last 40 years (figure 2B). However, we have not vetted this paper, and quantitatively measuring value-changes over time involves some obvious and hairy methodological issues, like around which values to choose and how much weight to place on different values. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-11)

12

“The sun is setting one evening over the ocean. You and a group of friends are standing at various points along the wet sand. As the water laps at your feet, you silently watch the red globe drop nearer and nearer to the horizon. As you watch, somewhat mesmerized, you notice how the sun's reflection on the wave crests forms a straight line composed of thousands of momentary orange-red glints-a straight line pointing right at you! "How lucky that I am the one who happens to be lined up exactly with that line!" you think to yourself.” (Hofstadter, ‘ [Heisenberg’s Uncertainty Principle and the Many Worlds Interpretation of Quantum Mechanics](https://gwern.net/doc/philosophy/ontology/1981-hofstadter.pdf)’.) [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-12)

13

A related point: you are more likely to have a worldview that currently has a lot of adherents. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-13)

14

You might also note that what really matters, from a utilitarian point of view, is the impact of society’s actions, today, on the long-term future. But, if so, it becomes very hard to assess whether we have seen moral progress or regress, in this regard, insofar as most of the most important attitudes concern emerging technologies, and we don’t know what people in the past would have thought about them. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-14)

15

Especially in rich countries, where the opportunity cost of not buying chicken is very small. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-15)

16

Not because you’d have learned anything relevant and new about what would happen as a result (it’s not that the present would actually make your partner worse-off, or anything like that). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-16)

17

See in particular the section on “Galaxy Joe”. Carlsmith, ‘ [On the limits of idealized values](https://joecarlsmith.com/2021/06/21/on-the-limits-of-idealized-values)’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-17)

18

We can represent this with a _quasilinear_ utility function, U(x,y)=f(x)+yU(x,y) = f(x) + yU(x,y)=f(x)+y, where xxx and yyy are bundles of self-interested and altruistic goods, respectively, and f(x)f(x)f(x) is strictly concave. So U(x,y)U(x,y)U(x,y) is linear with respect to altruistic goods, but not self-interested goods. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-18)

19

Total billionaire philanthropic spending is hard to estimate, but the 50 biggest US donors [gave around $16 billion](https://www.philanthropy.com/page/philanthropy-50) in 2024, and [just a third](https://en.wikipedia.org/wiki/List_of_countries_by_number_of_billionaires) of all the billionaires reside in the US, but some of the biggest US donors are not billionaires. UHNW individuals (defined as holding >$30 million in assets) gave an estimated $190 billion in 2022. Billionaires hold [around a quarter](https://altrata.com/reports/world-ultra-wealth-report-2024) of total UHNW wealth, so assuming equal proportional giving by assets, that suggests total billionaire giving was around $40–50 billion. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-19)

20

Note that the proportion is almost certainly larger strictly as a share of outlays, not including savings and investments, since billionaires on average likely reinvest the majority of their capital income. The philanthropic share of spending is perhaps 20–50%, although it’s difficult to directly estimate billionaire consumption. However, it remains true that a small fraction of wealth _accruing_ to billionaires is spent philanthropically per year — so although philanthropic spending can remain high as a fraction of all spending, this is partly compensated for by a transfer from lower wealth and income levels, assuming a lower saving rate (progressive taxation aside). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-20)

21

For relevant discussion, see Trammell, ‘ [Patient Philanthropy in an Impatient World](https://docs.google.com/document/d/1NcfTgZsqT9k30ngeQbappYyn-UO4vltjkm64n4or5r4/edit?usp=embed_facebook)’, Christiano, [‘Why might the future be good?’](https://rationalaltruist.com/2013/02/27/why-will-they-be-happy/). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-21)

22

Subjectivism is normally defined in terms of what’s right and wrong; we’ve adapted it to be about betterness, as that’s the focus of this essay series. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-22)
...
It’s also possible (and likely) that most people today just can’t be described as having a betterness ordering that can be represented with a cardinal value function at all. As we mentioned, those views are out of scope of the present discussion, but we’d welcome follow-up work which considers how they fit in. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-23)

24

See, for example, Smith, Lewis, and Johnston, ‘Dispositional Theories of Value\*’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-24)

25

Of course, some experiences are strongly desired and others aren’t. But this doesn’t establish agreement on which experiences are most valuable, for two reasons. First, arguably some people strongly desire experiences which others do not. Second, some experiences might induce strong desire, even when the subject doesn’t _themselves_ regard the experience as valuable. This could be true of some instances of drug addiction, or in the extreme case it has been shown to induce [strong desire for pain stimuli in mice](https://pmc.ncbi.nlm.nih.gov/articles/PMC7978410/#S9). Further, someone could consistently maintain that an experience is valuable or not, independently of whether it is endorsed or enjoyed by whoever experiences it. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-25)

26

One way to articulate this point is that experiences commonly regarded as hedonically valuable (pleasurable) are heterogeneous — they don’t appear to make a natural kind, beyond having in common that they are all commonly regarded as hedonically valuable. For example, Derek Parfit writes in _Reasons and Persons_: “Compare the pleasure of satisfying an intensive thirst or lust, listening to music, solving an intellectual problem, reading a tragedy, and knowing that one's child is happy. These various experiences do not contain any distinctive common quality”. This is sometimes called the “heterogeneity problem”. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-26)

27

One reply might be to say that everyone prefers experiences that are functionally attractive, and disprefers experiences which are functionally aversive. For example, at least part of what it is to be in a state of pain is a drive to avoid the pain. This could even ground judgements of value — pain is essentially bad because we find ourselves averse to it. Such a view suggests a natural target for convergence, even for antirealists: towards whichever brain states or computations (etc) are most attractive and away from whichever are most aversive. This is interesting, but not enough to establish convergence, because already many people strongly value experiences they don’t feel otherwise attracted to (like experiences which involve leaving one’s comfort zone), or they strongly value experiences which are aversive in other contexts and for other people, like intense exercise or sad movies. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-27)

28

You might think that there’s a much larger set of experiences that each person might regard as close to best. But in the last essay, _[No Easy Eutopia](https://www.forethought.org/research/no-easy-eutopia#32-unbounded-views)_, section 3.2, we argued that the distribution of value/cost is likely fat tailed, such that the vast majority of experiences are less than 50% of the value/cost as the highest value/cost experiences. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-28)

29

For a sustained argument along these lines, see Carlsmith, ‘ [On the limits of idealized values](https://joecarlsmith.com/2021/06/21/on-the-limits-of-idealized-values)’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-29)
...
But there are at least some reasons to doubt that your preferences are structured this way. The “you” at the end of reflection will likely be extraordinarily different from the you now, as will the post-reflection version of [some other person](https://joecarlsmith.com/2021/06/21/on-the-limits-of-idealized-values#iv-galaxy-joe). Hoping that most people end up, after reflection, with similar preferences to you might be like a six-year-old confidently believing they’ll be best friends forever with their classmate. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-30)

31

Assadi, ‘ [Will Humanity Choose its Future?](https://philarchive.org/rec/ASSWHC)’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-31)

32

Boudry, ‘ [On epistemic black holes: How self‐sealing belief systems develop and evolve](https://philpapers.org/rec/BOUOEB)’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-32)
...
We think this point is intellectually interesting, but probably of little practical importance. If you have a view on which atrocities can lower the upper bound on the best-achievable future, then you should probably be more concerned about avoiding futures involving atrocities over the long term than avoiding short-term atrocities in scenarios that are otherwise very good. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-33)

34

One-millionth of the global population today is around 8,000 people. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-34)

35

Ord, ‘Moral Trade’. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-35)

36

Harrison and Kreps, [‘Speculative Investor Behavior in a Stock Market with Heterogeneous Expectations’](https://www.jstor.org/stable/1884166). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-36)

37

It could be true that across cosmic distances, the opportunity cost of ‘domestic’ production could be lower than the cost of importing goods. But, to be clear, we are mostly imagining a period of bargaining before widespread space settlement — so the instruments being traded here are going to be more like options, futures, claims to, and other contracts regarding resources not yet accessed. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-37)

38

For example, in terms of the sum total of additional resources required by each actor under no trade to compensate for the gains in value, on their view, from trade. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-38)

39

This would be higher if: concessions highly valued by incorrect views are cheap on the preferred view; or concessions highly valued by the correct views are cheap on non-preferred views. In other words, the cost of achieving impartial value through trade is initially much lower than the cost without trade, on the preferred view. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-39)

40

This could depend on: (i) the bargaining power of the preferred view; (ii) the resources the preferred view initially controls; (iii) other changes to the world from trade not involving the preferred view. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-40)

41

For example, you could think that buying carbon offsets does make the world better, but that it is [wrong for nonconsequentialist reasons](https://slatestarcodex.com/2015/01/04/ethics-offsets/) to purchase carbon offsets. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-41)

42

Or contracts more generally, since examples where one or both parties perform some service, and don’t swap tangible goods, aren’t obviously “trades”. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-42)

43

Alice could also threaten to destroy something Bob positively values, refrain from actions Bob values, or refrain from cheaply producing something Bob values. Ultimately we find these possibilities less concerning, because it generally seems more effective for Alice (barring legal and other considerations) to cause specific harms or wrongs — in general, the threatening can exert more leverage at the same personal cost by threatening to specifically cause harm, than to destroy or refrain from producing a compensating amount of good. But note that, today, there are typically far fewer options for legal recourse against threats to refrain from causing large amounts of good. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-43)

44

For extant discussion, see: Clifton, [‘Preface to CLR’s Research Agenda on Cooperation, Conflict, and TAI’](https://www.lesswrong.com/posts/DbuCdEbkh4wL5cjJ5/preface-to-clr-s-research-agenda-on-cooperation-conflict-and), and Baumann, [‘Using surrogate goals to deflect threats’](https://longtermrisk.org/using-surrogate-goals-deflect-threats/). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-44)

45

As well as axiological views, some decision theories can be more vulnerable to the threats we’re concerned about here, too. We omit that discussion here. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-45)

46

Suppose that executed threats amount to 1% of all resources. Then if bads and goods weigh equally (e.g. on classical utilitarianism), even worst-case threats only reduce the value of the future by 2 percentage points. But if bads weigh 100x as much as goods, then 1% of resources spent on worst-case threats would mean that the future is certainly negative. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-46)

47

Of course legal systems today legislate against threats, extortion, and blackmail. Threatening a criminal act, especially physical violence, is often itself treated as a crime. Most legal systems have a concept of duress, where one party enters into a contract “unwillingly” or with “no reasonable alternative”. Legal concepts of blackmail typically rest on the threat of harms or damages to the victim, but the threshold is typically high: it is not unlawful for Bob to ask Alice for money because otherwise he’ll be sad, in a way which is distressing to Alice. But so far legal systems do not draw the line in a way that excludes the possibility of value-destroying threats, which suggests it might be very difficult to draw the line in an objective way. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-47)

48

Note that the _importance_ of doing so depends on how to normalise bounded and unbounded views under uncertainty: should the vast near-best world on an unbounded view loom much larger than the modest near-best world of a bounded view, given equal credence in both views? This was discussed in section 3.4 of [No Easy Eutopia](https://www.forethought.org/research/no-easy-eutopia#34-a-recap). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-48)

49

Consider how most rich countries criminalise the distribution of MDMA and psychedelic drugs, which are not highly valued by the majority, but are arguably not very socially harmful and are highly valued by a minority of people. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-49)

50

Consider, for example, max-preference-satisfaction versus [Kemeny-Young judgment aggregation](https://en.wikipedia.org/wiki/Kemeny%E2%80%93Young_method). [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-50)

51

Similarly, right now, none of us know what our reflective preferences are. So people are behind a veil of ignorance. Given this, people might be much more willing to make decisions in accordance with some particular widely-endorsed reflective process than they would after they have actually done the reflection themselves. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-51)

52

The case of pain is often described like this. It’s hard for some to imagine being in intense pain, but not at all thinking they are in pain; or thinking they are in intense pain, but in fact not being in pain. That suggests that being in pain just is something very like thinking you are in pain. Pain, then, is transparent to us. The thought is that this is true of the properties of goodness and badness themselves — what it is for an experience to be good is for it to feel good to us. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-52)

53

A similar result could follow on preference-satisfaction theories of wellbeing. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-53)

54

On the other hand, we might still hope that the concept of personal identity is fluid or indeterminate enough that either (i) the best-per-unit-resource experiences are accessible to a very wide variety of people, (ii) upon reflection, people would stop caring about personal identity, in which case their motivations would look much more impartial. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-54)

55

This is the “meta-ethical hedonist” position that we discussed in section 4.1. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-55)

56

Sadly, this argument only goes through if you are not already extremely powerful. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-56)

57

Where this is greater than your current fraction of power because of the chance that you are able to influence the most major decisions and engage in moral trade. [↩](https://www.forethought.org/research/convergence-and-compromise#user-content-fnref-57)