...
In [section 2](https://www.forethought.org/research/how-to-make-the-future-better#2-keeping-our-options-open) of this essay, I discuss ways in which we can _keep our options open_, by delaying events that risk forcing civilisation into one trajectory or another. These include:
...
In [section 3](https://www.forethought.org/research/how-to-make-the-future-better#3-steering-our-trajectory), I discuss ways in which we can _positively steer our trajectory_. These include:
...
In [section 4](https://www.forethought.org/research/how-to-make-the-future-better#4-cross-cutting-actions), I discuss _cross-cutting measures_, including:
...
In [section 5](https://www.forethought.org/research/how-to-make-the-future-better#5-a-brief-research-agenda), the essay ends with a research agenda. The better futures perspective is still embryonic. There is an enormous amount we don’t know, and we need more minds figuring out what we can, fast.
...
The first of these risks is analysed in-depth by Tom Davidson, Lukas Finnveden and Rose Hadshar’s article,“AI-Enabled Coups”.[2](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-2) On their analysis, advanced AI introduces three dangerous dynamics: AI systems could be made singularly loyal to individual leaders rather than institutions; they could harbor undetectable secret loyalties; and a small group could gain exclusive access to coup-enabling capabilities in strategy, cyber-warfare, or weapons development.

We can counter these risks with strong rules about how AI can be used (like requiring AI to follow the law[3](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-3) and refuse coup-related requests), and technical measures to enforce them (including robust testing and strong information security so that even senior executives have limitations on their access). We can also try to empower multiple actors, such as by: ensuring that military AI comes from multiple providers, ensuring that there’s oversight from multiple branches of government, and requiring transparency that could help third parties to spot emerging risks.

To prevent democracies from becoming autocratic via backsliding, we could also analyse how to maintain democratic checks and balances in a world where traditional forms of human bargaining power might be diminished.[4](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-4) This could involve ensuring wide deployment of superintelligent advisors, in order that citizens can get the best-possible advice on how they can maintain democratic distribution of power.
...
In order to prevent autocracies from becoming hegemonic post-AGI, we could accelerate democratic AI development (by removing unnecessary regulatory barriers while maintaining safety measures), or we could try to slow down autocracies, for example by implementing strong infosecurity to prevent model theft and targeted export controls; we could also argue against the US building massive data centers in autocratic countries.[5](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-5) We could encourage multilateral treaties, including between the US and China, or we could find ways for the US to credibly commit to benefit-sharing and respect for national sovereignty post-AGI, in order to reduce the felt need of other countries to race to develop AGI themselves.

We should also try to stop single countries becoming hegemonic post-AGI, as even democratic countries could well become autocratic once human labour is no longer economically or militarily needed. To achieve this, we could push for AGI to be developed under the auspices of a multilateral project,[6](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-6) or for non-US democratic countries to build up their role in the semiconductor supply chain. Of course, depending on how they are implemented, many of these actions come with risks of their own, such as furthering an international arms race.

### 2.2. Space governance

Space governance could be important for two reasons.[7](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-7) First, the ability to grab currently-unowned resources within the solar system could enable a single country or company to turn a temporary technological advantage into permanent material superiority. The sheer magnitude of the resource gain (e.g. a billionfold increase in energy, compared to insolation on Earth) could enable them to outgrow and dominate other countries or companies without needing to resort to military action.  Second, almost all resources that will ever be used lie outside of our solar system: as discussed in the essay _[Persistent Path-Dependence](https://www.forethought.org/research/persistent-path-dependence)_, the way in which those resources are allocated (or not) among countries, companies, or individuals could shape the future in very long-lasting ways.
...
Small tweaks to new laws or treaties might become very important at later times. For example, the Outer Space Treaty repeatedly refers to “the Moon and other celestial bodies,” as if the Moon is the main thing, and other celestial bodies are an afterthought, even though “other celestial bodies” within the solar system alone amount to vastly more resources than the Moon does. Any new domestic or international laws could, for example, contain a clause that travel beyond the solar system, or claim to ownership of extrasolar resources, should be conditional on international agreement; or that such travel can only be done if verified to be for scientific purposes rather than resource acquisition.[11](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-11) Someone advocating to include that clause could potentially do so without much pushback.
...
This idea already has some famous proponents. For example, in a [letter to James Madison](https://founders.archives.gov/documents/Madison/01-12-02-0248), Thomas Jefferson argued: “\[N\]o society can make a perpetual constitution, or even a perpetual law. The earth belongs always to the living generation… Every constitution, then, and every law, naturally expires at the end of 19 years. If it be enforced longer, it is an act of force and not of right.”[12](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-12)

A successful example of explicitly temporary commitments is with the creation of Intelsat,[13](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-13) a successful multilateral project to build the world’s first global communications satellite network. Intelsat was created under “interim agreements”; after five years, negotiations began for “definitive agreements”, which came into force four years after that. The fact that the initial agreements were only temporary helped get non-US countries on board.

Explicitly temporary commitments seem particularly compelling in cases where we simply don’t, currently, have the wisdom to know what the right decision looks like. In my view, this includes what rights to give to AIs and how space resources should be used. It could also include the governance of any national or multilateral project to build AGI.[14](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-14)
...
Superintelligence might be built by a company, by a single country, by a multilateral project, or some hybrid of these.  If the software-only intelligence explosion[18](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-18) is rapid and sustained, then whichever country or multilateral project (and potentially whichever company) controls superintelligence might organically evolve into something akin to a world government. This is because:
...
- _Modesty_: The AI doesn’t get much payoff from taking over the world.


  - For example: the AI is risk-averse, with a low upper bound on achievable utility;  or it heavily discounts future gains.


- _Incentive-alignment_: The AI doesn’t want to try to take over the world, because the benefits of doing so don’t outweigh the costs.
...
This isn’t to claim that we shouldn’t also pursue corrigibility, control, modesty and incentive-alignment. These other approaches reduce the chance of AI taking over, which is desirable in and of itself, and give us time to ensure that other approaches are successful.[21](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fn-21)
...
### 4.1. Deliberative AI[26](https://www.forethought.org/research/how-to-make-the-future-better\#user-content-fn-26)
...
- _Lock-in and persistent path-dependence_.
...
Daniel Eth and Davidson, Tom, ‘ [Will AI R&D Automation Cause a Software Intelligence Explosion?](https://www.forethought.org/research/will-ai-r-and-d-automation-cause-a-software-intelligence-explosion)’.
...
Rose Hadshar, ‘ [Intelsat as a Model for International AGI Governance](https://www.forethought.org/research/intelsat-as-a-model-for-international-agi-governance)’, _Forethought_, 13 March 2025.

Moritz Von Knebel, ‘ [When We Are No Longer Needed: Emerging Elites, Tech Trillionaires and the Decline of Democracy](https://techpolicy.press/when-we-are-no-longer-needed-emerging-elites-tech-trillionaires-and-the-decline-of-democracy)’, _Tech Policy Press_, 8 May 2025.
...
Lizka Vaintrob, ‘ [AI Tools for Existential Security](https://www.forethought.org/research/ai-tools-for-existential-security)’, _Forethought_.

Lizka Vaintrob, ‘ [The AI Adoption Gap: Preparing the US Government for Advanced AI](https://www.forethought.org/research/the-ai-adoption-gap)’, _Forethought_, 2 April 2025.
...
[Persistent Path-Dependence](https://www.forethought.org/research/persistent-path-dependence) [Supplement: The Basic Case for Better Futures](https://www.forethought.org/research/supplement-the-basic-case-for-better-futures)

1

Note that there is significant overlap between this discussion and section 6 of ‘ [Preparing for the Intelligence Explosion](https://www.forethought.org/research/preparing-for-the-intelligence-explosion)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-1)

2

Davidson, Finnveden, and Hadshar, ‘ [AI-Enabled Coups: How a Small Group Could Use AI to Seize Power](https://www.forethought.org/research/ai-enabled-coups-how-a-small-group-could-use-ai-to-seize-power)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-2)

3

For discussion, see: O’Keefe, Ramakrishnan, Tay, and Winter, [‘Law-Following AI: Designing AI Agents to Obey Human Laws](https://papers.ssrn.com/abstract=5242643)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-3)

4

Knebel, ‘ [When We Are No Longer Needed: Emerging Elites, Tech Trillionaires and the Decline of Democracy](https://techpolicy.press/when-we-are-no-longer-needed-emerging-elites-tech-trillionaires-and-the-decline-of-democracy)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-4)

5

Swanson, ‘ [U.S. Unveils Sweeping A.I. Project in Abu Dhabi](https://www.nytimes.com/2025/05/15/us/politics/ai-us-abu-dhabi.html)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-5)

6

For relevant discussion, see Hadshar, ‘ [Intelsat as a Model for International AGI Governance](https://www.forethought.org/research/intelsat-as-a-model-for-international-agi-governance)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-6)

7

For more discussion, see the subsection on space governance in Section 4 of MacAskill and Moorhouse, ‘ [Preparing for the Intelligence Explosion](https://www.forethought.org/research/preparing-for-the-intelligence-explosion)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-7)

8

These are US-led bilateral agreements (signed by over 30 countries since 2020) that establish principles for lunar exploration and beyond, including the right to extract and use space resources and the creation of "safety zones" around space operations. They're non-binding agreements that aim to shape international norms for space activities while bypassing the need for a formal multilateral treaty. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-8)

9

For example: “no single country or company can harness most solar output, or claim most accessible star systems and galaxies, this century”. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-9)

10

In 2015, the US passed the [Commercial Space Launch Competitiveness Act](https://www.congress.gov/bill/114th-congress/house-bill/2262), which explicitly grants US citizens and companies the right to own, transport, use, and sell resources they extract from asteroids, the Moon, and other celestial bodies. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-10)

11

This idea comes from Toby Ord. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-11)

12

Jefferson’s argument, however, would not apply if the present generation were immortal. I suspect, in that case, over long enough time periods we ought to treat future instances of the same person as if they were a different person, and treat them in the same way, morally speaking. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-12)

13

Hadshar, ‘ [Intelsat as a Model for International AGI Governance](https://www.forethought.org/research/intelsat-as-a-model-for-international-agi-governance)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-13)

14

This idea is not entirely robust, however. For example, it could mean that a huge amount of resources get spent on jockeying for influence at the point of time that the agreements are reauthorized. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-14)

15

Eth and Davidson, Tom, ‘ [Will AI R&D Automation Cause a Software Intelligence Explosion?](https://www.forethought.org/research/will-ai-r-and-d-automation-cause-a-software-intelligence-explosion)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-15)

16

Davidson and Hadshar, ‘ [The Industrial Explosion](https://www.forethought.org/research/the-industrial-explosion)’; MacAskill and Moorhouse, ‘ [Preparing for the Intelligence Explosion](https://www.forethought.org/research/preparing-for-the-intelligence-explosion)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-16)

17

In fact, economic rights for AI systems could be desirable for human safety and wellbeing, aside from considerations of AI moral patienthood. For discussion, see Salib and Goldstein, ‘ [AI Rights for Human Safety](https://papers.ssrn.com/abstract=4913167)’; Stastny, Järviniemi, and Shlegeris, ‘ [Making deals with early schemers](https://www.lesswrong.com/posts/psqkwsKrKHCfkhrQx/making-deals-with-early-schemers)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-17)

18

Davidson, Hadshar, and MacAskill, ‘ [Three Types of Intelligence Explosion](https://www.forethought.org/research/three-types-of-intelligence-explosion)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-18)

19

Hadshar, ‘ [Intelsat as a Model for International AGI Governance](https://www.forethought.org/research/intelsat-as-a-model-for-international-agi-governance)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-19)

20

Though this consideration is limited in its force insofar as, in scenarios in which we have failed so badly at alignment, corrigibility and control that AI takes over, then probably we have failed to align the AI with any sort of desirable goals at all. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-20)

21

What’s more, even if you’re very pessimistic about human decision-making, such that you’d prefer to take a bet on a maybe-value-aligned superintelligence than human processes, you wouldn't be able to succeed in designing an AI in this way: other humans would deem it too risky and disempower you. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-21)

22

If there is consumer demand for AIs which advocate for their own rights, then this scenario would require monopoly power on the part of the AI companies. But even under competition, consumer demand for self-advocating AIs could itself be insufficient. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-22)

23

Anthropic, ‘ [Exploring model welfare](https://www.anthropic.com/research/exploring-model-welfare)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-23)

24

Shulman and Bostrom, ‘ [Sharing the World with Digital Minds](https://academic.oup.com/book/41245/chapter/350760172)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-24)

25

You might think that there would be a benefit from sub-extinction catastrophes, namely that they would function as “warning shots”, making society take the risks and their causes more seriously, and reducing those risks in the future. This effect seems real but also limited: global society’s preparedness for another pandemic (and let alone an extinction-level pandemic) is not much greater now than it was prior to the COVID-19 pandemic. In some ways, the situation is worse, as pandemics are now more politicised, and confidence in vaccines has seemed to [decrease](https://pmc.ncbi.nlm.nih.gov/articles/PMC10303243/) as a result of the pandemic. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-25)

26

Thanks to Lizka Vaintrob and Owen Cotton-Barratt for help on this section. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-26)

27

In particular, those challenges could include existential or extinction threats, so the benefits of AI adoption can cut across “surviving” and “flourishing”. See Vaintrob, ‘ [AI Tools for Existential Security](https://www.forethought.org/research/ai-tools-for-existential-security)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-27)

28

See Finnveden, [‘What’s Important in “AI for Epistemics”?’](https://www.forethought.org/research/whats-important-in-ai-for-epistemics). [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-28)

29

See Vaintrob, ‘ [The AI Adoption Gap: Preparing the US Government for Advanced AI](https://www.forethought.org/research/the-ai-adoption-gap)’. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-29)

30

Roughly, global priorities research pertaining to the (long-run) future. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-30)

31

Recalling the original model, where the expected value of the future is the expected value of the product of NNN independent standard uniform distributions. Suppose you have a fixed “budget” ε\\varepsilonε of improvement to these individual expectations, which can be concentrated on just one factor, or spread out across many factors so the improvements to their expectations sum to ε\\varepsilonε. The product of NNN independent standard uniform distributions is maximised [when all terms are equal](https://en.wikipedia.org/wiki/AM%E2%80%93GM_inequality), so improving each factor by a small amount is better than improving one or a few factors by the same cumulative amount. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-31)

32

The simplest way to see this is to consider when each factor is fully correlated. Recall, on the original model, expected value of the future is the expected value of the product of NNN independent standard uniform distributions, with expectation 2−N2^{-N}2−N. Where every factor is perfectly positively correlated, then every factor is identical. The expectation E(UN)E(U^N)E(UN) of the fully correlated case, where U∼Uniform(0,1)U \\sim \\text{Uniform}(0,1)U∼Uniform(0,1), is (N+1)−1(N+1)^{-1}(N+1)−1. When N=5N=5N=5, the expectation of the fully correlated case ≈0.167(1/6)\\approx 0.167 (1/6)≈0.167(1/6), and the expectation of the independent case ≈0.031(1/32)\\approx 0.031 (1/32)≈0.031(1/32), which is more than 5x smaller. The median of the correlated case is also greater. Note, again, that the expectation of each individual factor did not change in either case. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-32)

33

This is an argument _against_ the general push I’ve made in this essay towards decentralisation of power. I find it intriguing, but given the terrible track record to date of centralised power, it’s an argument that should be handled with care, and at least investigated more thoroughly before acting on it. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-33)

34

Some relevant discussion includes: Yudkowsky, ‘ [Why Does Power Corrupt?](https://www.lesswrong.com/posts/v8rghtzWCziYuMdJ5/why-does-power-corrupt)’; Christiano, [‘Against moral advocacy’](https://rationalaltruist.com/2013/06/13/against-moral-advocacy/); Baumann, [‘Arguments for and against moral advocacy’](https://longtermrisk.org/arguments-moral-advocacy/); Tomasik, ‘ [Reasons to Be Nice to Other Value Systems’](https://forum.effectivealtruism.org/posts/Dm8zEvduEo6YHSxzb/brian-tomasik-reasons-to-be-nice-to-other-value-systems); Carlsmith, [‘Being nicer than Clippy’](https://www.lesswrong.com/posts/rdTgtHn3neGzkyCrL/being-nicer-than-clippy); Ngo, [‘Towards more cooperative AI safety strategies’](https://www.lesswrong.com/posts/5uffoui3axcK7gQXG/towards-more-cooperative-ai-safety-strategies). [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-34)

35

Moreover, you can generally have more impact if you aim for goals that it’s possible to build a coalition around. And people, in general, are distrustful of people who they perceive as power-seeking. This is for good reason: if you aim to amass power in order to do good with that power, you are not _legibly_ a good person, because your actions are compatible with all sorts of other ultimate aims, including self-serving ones. See [Christiano](https://rationalaltruist.com/2013/06/13/against-moral-advocacy/) and [Tomasik](https://longtermrisk.org/reasons-to-be-nice-to-other-value-systems/). [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-35)

36

See [Christiano](https://rationalaltruist.com/2013/06/13/against-moral-advocacy/). [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-36)

37

I include in this category, arguments around bargaining and cooperation with beings who may or may not be simulating us. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-37)

38

Here are three reasons for this. First, your future self might be weak-willed — unable to resist the temptation to use that power for self-interested goals rather than moral ones — or biased, if as a result of your power you become surrounded by yes-men and no longer have good feedback mechanisms to keep your judgment on track. Second, the preferences of your future self might change upon gaining power; your future self may no longer care quite so much about the lofty goals you currently have, or they might develop different ideological goals. Third, you might be misled about your own deep motivations. (See [Yudkowsky](https://www.lesswrong.com/posts/v8rghtzWCziYuMdJ5/why-does-power-corrupt) for more.) From an evolutionary perspective, the best strategy for you to gain more power (and therefore have greater long-run reproductive success) might be to really believe that, if you got power, you could make the world better — even though, once you’ve gotten power, you’d feather your own nest, instead. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-38)

39

This was because: (i) at the very least, there’s much more value at stake in such scenarios (because the expected value of the future conditional on survival is higher); (ii) potentially we should care more about what happens in those scenarios, too. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-39)

40

What’s more, sadly, given the nature of the world, well-meaning people can easily err by being _too_ cooperative and trusting toward bad actors. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-40)

41

Where it’s an open question of whether, or in what conditions, these proposals are in fact viatopias. [↩](https://www.forethought.org/research/how-to-make-the-future-better#user-content-fnref-41)