...
url: https://www.forethought.org/research/persistent-path-dependence
---
...
First, you might think that reducing the risk of human extinction by one percentage point increases the probability that there is any civilisation in our cosmic neighborhood by one percentage point. But this isn’t right. If humans go extinct and most other mammals do not, it seems quite likely to me (more than 50%)[2](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-2) that, in the hundreds of millions of years remaining before the Earth is no longer habitable, some other species will develop higher intelligence, cumulative cultural evolution and technological capability, such that they can rebuild civilisation in our stead.[3](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-3) And, even if all life on Earth is wiped out, or if higher intelligence never re-evolves, it seems somewhat likely to me (around 50%)[4](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-4) that alien civilisations will eventually settle our part of the cosmos.[5](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-5)
...
On this definition, a lock-in event doesn't need to involve some feature coming about and then persisting indefinitely — it’s just that it results in a reduction in uncertainty about how that feature will _ultimately_ turn out.[11](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-11)
...
One reason you might object to the idea of persistent path-dependence is on the basis of history to date. In the past, civilisation has been in constant flux, and you might think that almost nothing has had persistently path-dependent effects.[12](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-12) So, shouldn't we expect this flux to continue into the future, making predictable long-term persistence unlikely?
...
Throughout, I assume it’s at least reasonably likely that society will develop AGI in our lifetimes, and that this will drive explosive technological development. Because of this explosive development, we will race, over a period of just years or decades, through many of the technologies and societal developments that are relevant to persistent path-dependence. This is why we might, quite suddenly,[13](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-13) move from a world where the future is highly open to one in which its trajectory seems clear.
...
The argument for why AGI-based institutions could allow certain values or goals to persist indefinitely is made at length in ‘AGI and Lock-in’ by Lukas Finnveden et al[14](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-14). Though it’s worth reading the whole thing, I’ll briefly recap the argument in my own words here.
...
In international relations theory, “defense-dominance” refers to a situation where defending territory, resources, or positions of power is significantly easier and less costly than attacking or conquering them.[18](https://www.forethought.org/research/persistent-path-dependence#user-content-fn-18) When defense-dominant conditions prevail, even relatively weaker entities can maintain control of their territory against stronger aggressors, creating stable power arrangements that resist change.
...
S. Jay Olson, ‘ [On the Likelihood of Observing Extragalactic Civilizations: Predictions from the Self-Indication Assumption](https://arxiv.org/abs/2002.08194v1)’, _arXiv.org_, 18 February 2020.
...
[Convergence and Compromise](https://www.forethought.org/research/convergence-and-compromise) [How to Make the Future Better](https://www.forethought.org/research/how-to-make-the-future-better)